...
const RegisterScreen = ({location, history}) => {
    ...
    console.log('verification',userVerification);
    const userRegister = useSelector((state) => state.userRegister)
    const {userData, loading: loadingRegister, error: errorRegister} = userRegister
        ...
        <FormContainer>
            ...
            <Form onSubmit={submitHandler}
                ...
                <Form.Group controlId='contact No'>
                    ...
                    <Form.Control type='contact' placeholder='Enter Mobile No'
                        value={contact}
                        onChange={
            ...
            <Row className='py-3'>
                ...
                <Col>
                    ...
                    <span className='btn-primary mb-3 '>
                        Login</span>
            ...
            {
            errorRegister && <Message variant='danger'>
